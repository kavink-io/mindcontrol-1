        ...
        <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    {/* Simulation Slider (To replace with Real Sensor later) */}
                    <div className="bg-white rounded-3xl p-6 shadow-lg border border-slate-100">
                        <div className="flex items-center gap-2 mb-4">
                            <Settings2 size={18} className="text-slate-400" />
                            <h3 className="font-bold text-slate-700 text-sm">Signal Threshold</h3>
                        </div>
                        <input
                            type="range"
                            min="10"
                        ...
                        <div className="flex justify-between mt-2 text-xs text-slate-400 font-mono">
                            <span>10µS</span>
                            <span>{stressThreshold}µS (Trigger)</span>
                            <span>40µS</span>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className={`w-40 h-40 mx-auto rounded-full flex items-center justify-center text-white text-2xl font-bold mb-8 transition-colors ${
